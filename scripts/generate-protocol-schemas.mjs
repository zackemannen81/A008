...
import { v1JsonSchemas, v1OpenApiDocument, v2AuthJsonSchemas, v2AuthOpenApiDocument } from "../dist/packages/protocol/src/index.js";
const directory = new URL("../packages/protocol/schemas/", import.meta.url);
mkdirSync(directory, { recursive: true });
for (const [name, schema] of Object.entries({ ...v1JsonSchemas(), ...v2AuthJsonSchemas() })) {
