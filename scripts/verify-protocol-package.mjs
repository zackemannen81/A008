...
try {
  ...
  writeFileSync(join(consumer, "proof.ts"), `import { parseClientMessage, parseServerMessage, clientMessageSchema, validateV1HttpResponse, parseUploadedSource, v1OpenApiDocument, v2TicketRequestSchema, v2AuthOpenApiDocument, type ClientMessage, type UploadedSource } from '@a008/protocol';
