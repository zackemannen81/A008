...
export const KIE_MARKET_MODELS: readonly KieMarketModel[] = [
  ...
  { id: "flux-2/flex-text-to-image", name: "FLUX.2 Flex text-to-image", kind: "image" },
  { id: "google/imagen4-fast", name: "Google Imagen 4 Fast", kind: "image" },
  { id: "grok-imagine/text-to-image", name: "Grok Imagine text-to-image", kind: "image" },
  { id: "qwen/text-to-image", name: "Qwen text-to-image", kind: "image" },
  { id: "kling/v3-turbo-text-to-video", name: "Kling V3 Turbo text-to-video", kind: "video" },
...
export function isKieChatModelId(id: string): boolean {
  return KIE_MARKET_MODELS.some((model) => model.id === id && model.kind === "chat");
}
