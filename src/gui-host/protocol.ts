...
export { errorMessage, type ParseFailure } from "../../packages/protocol/src/index.js";
import type { ClientMessage, HostServerMessage } from "../../packages/protocol/src/index.js";
...
export function parseClientMessage(raw: string) { return parseWireMessage(raw, parseSessionControl); }
