export const KNOWLEDGE_EXTRACTOR_INSTRUCTION = [
  ...
  "For every durable artifact whose subject is clear enough to classify, emit 1-4 domains with the smallest useful set of broad reusable subject areas.",
  ...
  "Choose 1-16 specific tags for the artifact's meaning: for example typewriter, dialogue text and text colour for a typewriter-text colour property. Do not omit useful tags merely because domains or entities are present.",
