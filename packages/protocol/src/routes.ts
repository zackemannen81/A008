...
export const v1HttpRoutes = [
  ...
  ["GET", "/v1/memory", "current bridge project / fixed panel session", "ACP inspection"],
  ...
  ["GET", "/v1/provider-settings", "host configuration; no credential values", "provider-routes"],
  ["POST", "/v1/provider-settings", "host credential/configuration mutation", "provider-routes"],
  ["POST", "/v1/images", "host provider job and source store", "provider-routes"],
  ...
  ["GET/HEAD", "/{asset}", "static assets; root PIN login page when enabled", "server"],
] as const;
