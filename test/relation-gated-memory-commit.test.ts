...
const PROJECT = parseRuntimeId(
  "a007_v1_project_50000000-0000-4000-8000-000000000001",
  "project",
);
const CONVERSATION = parseRuntimeId(
  "a007_v1_conversation_50000000-0000-4000-8000-000000000002",
  "conversation",
);
const TASK = parseRuntimeId(
  "a007_v1_task_50000000-0000-4000-8000-000000000003",
  "task",
);
const AGENT = parseRuntimeId(
  "a007_v1_agent_50000000-0000-4000-8000-000000000004",
  "agent",
);
