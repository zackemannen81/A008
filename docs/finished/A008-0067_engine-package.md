...
- [x] Root and GUI typecheck/build and full npm test.
- [x] External client typecheck, tests and build plus adapter contract tests.
- [x] Actual extracted-package discovery/start/session/panel/stop proof.
- [x] Fake provider to real isolated tool execution and tool-result continuation.
- [x] Project/session isolation, cross-surface state, cancellation and permissions.
- [x] Desktop browser panel/settings/memory/upload proof, no paid provider call.
- [x] Docs links/fences, secret boundary, git diff --check, archive and handoff.
...
- [x] Implement engine composition and session-bound panels.
- [x] Implement model tools and approved execution.
- [x] Integrate generic panels/permissions into the external client.
- [x] Package, test, verify surfaces and complete documentation.
...
Implementation 649a32d and companion 5b0abb2. Root 553 and client 590 passing tests, both builds/typechecks, actual fresh ZIP extraction and browser proof passed. See ../evidence/A008-0067_engine-package.md and ../handoffs/A008-0067.md. No push, PR, merge or live provider call.
