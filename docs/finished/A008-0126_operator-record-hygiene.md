...
- [x] Review 0121/0122 existing handoffs and 0124 implementation ancestry.
- [x] Confirm 0120/0123/0125 are not modified.
- [x] Confirm `CURRENT_TASK` equals the canonical template at completion.
- [x] `git diff --check` passes.

## Checklist

- [x] Repair A008-0122 journal.
- [x] Write A008-0124 handoff and journal.
- [x] Mark A008-0124 Superseded with a narrow status note.
- [x] Archive A008-0126 and write its handoff.
- [x] Restore `CURRENT_TASK` template and run docs hygiene checks.
