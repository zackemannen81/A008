...
- [ ] Review supplied requirements and exact source owners against the specification.
- [ ] Calculate proposed half-life/dormancy/boost examples independently.
- [ ] Review authority conflicts and all anti-drift acceptance cases.
- [ ] Check changed Markdown references, fences, indexes and staged secret patterns.
- [ ] Check frozen charter, existing immutable records, product-file preservation and template bytes.
- [ ] Run git diff --check; record runtime/live checks as not performed.
...
- [ ] Write and review the bounded specification.
- [ ] Calculate examples and verify documentation.
- [ ] Update owning records, archive and hand off.
- [ ] Restore CURRENT_TASK, integrate locally and journal.
...
- [ ] CURRENT_STATUS, backlog index and FILESTRUCTURE.
- [ ] SYSTEMDOC reviewed; no behavior changed, so no prospective runtime claims.
- [ ] Archive, handoff and operator JOURNAL entry.

## Handoff and Follow-ups

- Current state: specification task Ready.
- Next recommended step: author and verify the proposed specification.
- Blockers: none for specification authoring.
- Child tasks: none.
- Resume condition: repository plus the completed specification.
- Open questions: proposed policy choices will be listed for implementation decisions.
