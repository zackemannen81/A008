...
- [x] Freeze charter.
- [ ] Reproduce with the installed agent-browser MCP command through the existing probe.
- [ ] Implement only the proven A008-owned repair or diagnostics.
- [ ] Run verification and update documentation/handoff/archive.
...
- Current state: Ready.
- Next recommended step: Run the A008 stdio probe against installed agent-browser.
- Blockers: None.
- Child tasks: None.
