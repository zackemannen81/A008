...
| 4. Turns and recovery | Not started | Stage 3.5 GO. Snapshot boundary, idempotency, cancellation/restart proof remain Stage 4 and must not use ACME execution identity |
