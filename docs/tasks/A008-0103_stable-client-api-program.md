...
| 4. Turns and recovery | Complete; A008-0132/0138/0139/0140 | Stable identities/order/snapshots/terminal outcomes, bounded receipts/idempotency, reconnect lease and restart uncertainty all verified; Stage 5 may start |
| 5. SDK and web migration | Complete; A008-0149 | Independent `@a008/client` package, credential adapters, bundled GUI consumes SDK; Expo remains Stage 6 |
