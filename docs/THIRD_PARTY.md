...
| `highlight.js` | 11.12.0 | BSD-3-Clause | GUI syntax highlighting for chat code fences and Code Canvas. Owner-supplied local CDN assets at this version were the pin; the npm package is the runtime dependency. Not copied from Desktop. |
