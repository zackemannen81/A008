...
an A007 task ID and creates a reviewed charter. A proposal keeps its stable path
...
| --- | --- | --- |
| [`legacy-credential-remediation.md`](legacy-credential-remediation.md) | Completed | Credential revoked/rotated; secure provider-neutral intake delivered by A007-0003. |
| [`first-shared-chat-slice.md`](first-shared-chat-slice.md) | Completed | A007-0003 through A007-0005 prove CLI/core, ACP, and visible Canvas loopback behavior. |
