...
| --- | --- | --- |
| [instruction-plane-and-memory-lifecycle.md](instruction-plane-and-memory-lifecycle.md) | Accepted | Frozen by ADR 0035, including P1–P6. A008-0080 completes L1; A008-0081 completes L2. L3 retains its own charter and gates. |
