...
| Knowledge-model program | A008-0021 is In Progress. ADR 0018 accepted. Wave 1 merged: A008-0023 (M1 eligibility on v0 path) and A008-0024 (M3 `src/memory/knowledge/` INTERPRET). Wave 2 is A008-0025 (M4) and A008-0026 (M5). M2 is not a task. |
