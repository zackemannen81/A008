...
| Knowledge-model program | A008-0021 is In Progress at `docs/tasks/A008-0021_close-knowledge-model-gap.md`. `docs/CURRENT_TASK.md` on `main` is the empty template. M1 and M3–M7 implemented on this branch (A008-0028). In-memory and SQLite S1–S10 payloads match; live CLI/ACP use the knowledge engine. M2 is not a task. |
