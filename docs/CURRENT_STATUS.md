...
| Knowledge-model program | A008-0021 is In Progress at `docs/tasks/A008-0021_close-knowledge-model-gap.md`. `docs/CURRENT_TASK.md` on `main` is the empty template. M1 and M3–M6 merged. In-memory S1–S10 plus decay sweep are green per A008-0027 handoff (189 tests). Next is A008-0028 (M7 storage). M2 is not a task. |
