...
| Knowledge-model program | A008-0021 is In Progress at `docs/tasks/A008-0021_close-knowledge-model-gap.md`. `docs/CURRENT_TASK.md` on `main` is the empty template. ADR 0018 accepted. Wave 1 merged: A008-0023 and A008-0024. Wave 2 is A008-0025 (M4) and A008-0026 (M5). M2 is not a task. |
