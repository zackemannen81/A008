...
| Knowledge-model program | A008-0021 is In Progress at `docs/tasks/A008-0021_close-knowledge-model-gap.md`. `docs/CURRENT_TASK.md` on `main` is the empty template. Wave 1 and wave 2 merged (M1, M3, M4, M5). Next is A008-0027 (M6). M2 is not a task. |
