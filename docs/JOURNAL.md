...
- Added renderer-local File, Edit, View and Help menus plus a persistent 208–480 px desktop sidebar splitter with pointer/keyboard operation and a hide/show control.
